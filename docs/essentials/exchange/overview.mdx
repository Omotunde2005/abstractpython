...
If your app accepts currency codes from users as input, you may need to validate these inputs before querying the `ExchangeRatesAPI` class. 
...
if base_currency in EXCHANGE_SUPPORTED_CURRENCIES:
    # Query a method within the ExchangeRatesAPI class 
```
