...
An historical date that the response must refer to. This parameter should be used if you want to get past exchange rates. 
...
The base amount equivalent of the target currency.
</ResponseField>
